 ...
 */
PJ_DEF(pj_in_addr)
pj_inet_addr(const pj_str_t *cp) {
    pj_in_addr addr;
 ...
 */
PJ_DEF(char *)
pj_inet_ntop2(int af, const void *src,
              char *dst, int size) {
    pj_status_t status;
 ...
 */
PJ_DEF(char *)
pj_sockaddr_print(const pj_sockaddr_t *addr,
                  char *buf, int size,
                  unsigned flags) {
    enum {
        WITH_PORT = 1,
 ...
 */
PJ_DEF(pj_status_t)
pj_sockaddr_in_set_str_addr(pj_sockaddr_in *addr,
...
PJ_DEF(pj_status_t)
pj_sockaddr_set_str_addr(int af,
                         pj_sockaddr *addr,
                         const pj_str_t *str_addr) {
    pj_status_t status;
 ...
 */
PJ_DEF(pj_status_t)
pj_sockaddr_in_init(pj_sockaddr_in *addr,
                    const pj_str_t *str_addr,
                    pj_uint16_t port) {
 ...
 */
PJ_DEF(int)
pj_sockaddr_cmp(const pj_sockaddr_t *addr1,
 ...
 */
PJ_DEF(pj_uint16_t)
pj_sockaddr_in_get_port(const pj_sockaddr_in *addr) {
 ...
 */
PJ_DEF(void *)
pj_sockaddr_get_addr(const pj_sockaddr_t *addr) {
 ...
 */
PJ_DEF(pj_bool_t)
pj_sockaddr_has_addr(const pj_sockaddr_t *addr) {
    const pj_sockaddr *a = (const pj_sockaddr *) addr;
 ...
 */
PJ_DEF(pj_uint16_t)
pj_sockaddr_get_port(const pj_sockaddr_t *addr) {
    const pj_sockaddr *a = (const pj_sockaddr *) addr;
 ...
 */
PJ_DEF(unsigned)
pj_sockaddr_get_addr_len(const pj_sockaddr_t *addr) {
    const pj_sockaddr *a = (const pj_sockaddr *) addr;
    PJ_ASSERT_RETURN(a->addr.sa_family == PJ_AF_INET ||
                             a->addr.sa_family == PJ_AF_INET6,
                     0);
    return a->addr.sa_family == PJ_AF_INET6 ? sizeof(pj_in6_addr) : sizeof(pj_in_addr);
}
 ...
 */
PJ_DEF(unsigned)
pj_sockaddr_get_len(const pj_sockaddr_t *addr) {
    const pj_sockaddr *a = (const pj_sockaddr *) addr;
    PJ_ASSERT_RETURN(a->addr.sa_family == PJ_AF_INET ||
                             a->addr.sa_family == PJ_AF_INET6,
                     0);
    return a->addr.sa_family == PJ_AF_INET6 ? sizeof(pj_sockaddr_in6) : sizeof(pj_sockaddr_in);
}
 ...
 */
PJ_DEF(void)
pj_sockaddr_copy_addr(pj_sockaddr *dst,
 ...
 */
PJ_DEF(void)
pj_sockaddr_cp(pj_sockaddr_t *dst, const pj_sockaddr_t *src) {
 ...
 */
PJ_DEF(void)
pj_sockaddr_in_set_port(pj_sockaddr_in *addr,
 ...
 */
PJ_DEF(pj_status_t)
pj_sockaddr_set_port(pj_sockaddr *addr,
                     pj_uint16_t hostport) {
 ...
 */
PJ_DEF(pj_in_addr)
pj_sockaddr_in_get_addr(const pj_sockaddr_in *addr) {
    pj_in_addr in_addr;
 ...
 */
PJ_DEF(void)
pj_sockaddr_in_set_addr(pj_sockaddr_in *addr,
 ...
 */
PJ_DEF(pj_status_t)
pj_sockaddr_parse2(int af, unsigned options,
                   const pj_str_t *str,
                   pj_str_t *p_hostpart,
                   pj_uint16_t *p_port,
                   int *raf) {
 ...
 */
PJ_DEF(pj_status_t)
pj_sockaddr_parse(int af, unsigned options,
                  const pj_str_t *str,
                  pj_sockaddr *addr) {
    pj_str_t hostpart;
    pj_uint16_t port;
...
PJ_DEF(pj_status_t)
pj_gethostip(int af, pj_sockaddr *addr) {
 ...
 */
PJ_DEF(pj_status_t)
pj_sock_bind_random(pj_sock_t sockfd,
 ...
 */
PJ_DEF(pj_status_t)
pj_sock_setsockopt_sobuf(pj_sock_t sockfd,
                         pj_uint16_t optname,
...
PJ_DEF(int)
pj_IPTOS_LOWDELAY(void) {
    return PJ_IPTOS_LOWDELAY;
}

PJ_DEF(int)
pj_IPTOS_THROUGHPUT(void) {
    return PJ_IPTOS_THROUGHPUT;
}

PJ_DEF(int)
pj_IPTOS_RELIABILITY(void) {
    return PJ_IPTOS_RELIABILITY;
}

PJ_DEF(int)
pj_IPTOS_MINCOST(void) {
...
PJ_DEF(pj_uint16_t)
pj_SO_REUSEADDR(void) {
    return PJ_SO_REUSEADDR;
}

PJ_DEF(pj_uint16_t)
pj_SO_NOSIGPIPE(void) {
...
PJ_DEF(pj_uint16_t)
pj_IP_MULTICAST_IF(void) {
    return PJ_IP_MULTICAST_IF;
}

PJ_DEF(pj_uint16_t)
pj_IP_MULTICAST_TTL(void) {
    return PJ_IP_MULTICAST_TTL;
}

PJ_DEF(pj_uint16_t)
pj_IP_MULTICAST_LOOP(void) {
    return PJ_IP_MULTICAST_LOOP;
}

PJ_DEF(pj_uint16_t)
pj_IP_ADD_MEMBERSHIP(void) {
    return PJ_IP_ADD_MEMBERSHIP;
}

PJ_DEF(pj_uint16_t)
pj_IP_DROP_MEMBERSHIP(void) {
