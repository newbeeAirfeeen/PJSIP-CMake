...
PJ_DEF(pj_status_t)
pj_lock_create_simple_mutex(pj_pool_t *pool,
                            const char *name,
                            pj_lock_t **lock) {
...
PJ_DEF(pj_status_t)
pj_lock_create_recursive_mutex(pj_pool_t *pool,
                               const char *name,
                               pj_lock_t **lock) {
...
PJ_DEF(pj_status_t)
pj_lock_create_null_mutex(pj_pool_t *pool,
                          const char *name,
                          pj_lock_t **lock) {
    PJ_UNUSED_ARG(name);
    PJ_UNUSED_ARG(pool);
...
PJ_DEF(pj_status_t)
pj_lock_create_semaphore(pj_pool_t *pool,
                         const char *name,
                         unsigned initial,
                         unsigned max,
                         pj_lock_t **lock) {
...
PJ_DEF(pj_status_t)
pj_grp_lock_create(pj_pool_t *pool,
...
PJ_DEF(pj_status_t)
pj_grp_lock_create_w_handler(pj_pool_t *pool,
                             const pj_grp_lock_config *cfg,
                             void *member,
...
PJ_DEF(pj_status_t)
pj_grp_lock_replace(pj_grp_lock_t *old_lock,
...
PJ_DEF(pj_status_t)
pj_grp_lock_add_handler(pj_grp_lock_t *glock,
                        pj_pool_t *pool,
                        void *comp,
                        void (*destroy)(void *comp)) {
...
PJ_DEF(pj_status_t)
pj_grp_lock_del_handler(pj_grp_lock_t *glock,
                        void *comp,
                        void (*destroy)(void *comp)) {
    grp_destroy_callback *cb;
...
#if PJ_GRP_LOCK_DEBUG
PJ_DEF(pj_status_t)
pj_grp_lock_add_ref_dbg(pj_grp_lock_t *glock,
                        const char *file,
                        int line) {
    grp_lock_ref *ref;
    pj_status_t status;
...
PJ_DEF(pj_status_t)
pj_grp_lock_dec_ref_dbg(pj_grp_lock_t *glock,
                        const char *file,
                        int line) {
    grp_lock_ref *ref;
...
#else
PJ_DEF(pj_status_t)
pj_grp_lock_add_ref(pj_grp_lock_t *glock) {
    return grp_lock_add_ref(glock);
}

PJ_DEF(pj_status_t)
pj_grp_lock_dec_ref(pj_grp_lock_t *glock) {
    return grp_lock_dec_ref(glock);
}
#endif

PJ_DEF(int)
pj_grp_lock_get_ref(pj_grp_lock_t *glock) {
    return pj_atomic_get(glock->ref_cnt);
}

PJ_DEF(pj_status_t)
pj_grp_lock_chain_lock(pj_grp_lock_t *glock,
                       pj_lock_t *lock,
                       int pos) {
...
PJ_DEF(pj_status_t)
pj_grp_lock_unchain_lock(pj_grp_lock_t *glock,
                         pj_lock_t *lock) {
    grp_lock_item *lck;
