...
PJ_DEF(void)
PJ_FD_SET(pj_sock_t fd, pj_fd_set_t *fdsetp) {
    PJ_CHECK_STACK();
    pj_assert(sizeof(pj_fd_set_t) - sizeof(pj_sock_t) >= sizeof(fd_set));
...
PJ_DEF(void)
PJ_FD_CLR(pj_sock_t fd, pj_fd_set_t *fdsetp) {
    PJ_CHECK_STACK();
    pj_assert(sizeof(pj_fd_set_t) - sizeof(pj_sock_t) >= sizeof(fd_set));
...
PJ_DEF(pj_bool_t)
PJ_FD_ISSET(pj_sock_t fd, const pj_fd_set_t *fdsetp) {
    PJ_CHECK_STACK();
