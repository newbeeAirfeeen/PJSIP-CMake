 ...
 */
PJ_DEF(pj_status_t)
pj_stun_sock_create(pj_stun_config *stun_cfg,
                    const char *name,
                    int af,
...
/* Start socket. */
PJ_DEF(pj_status_t)
pj_stun_sock_start(pj_stun_sock *stun_sock,
...
/* Associate user data */
PJ_DEF(pj_status_t)
pj_stun_sock_set_user_data(pj_stun_sock *stun_sock,
                           void *user_data) {
...
/* Get info */
PJ_DEF(pj_status_t)
pj_stun_sock_get_info(pj_stun_sock *stun_sock,
...
PJ_DEF(pj_status_t)
pj_stun_sock_sendto(pj_stun_sock *stun_sock,
                    pj_ioqueue_op_key_t *send_key,
                    const void *pkt,
                    unsigned pkt_len,
                    unsigned flag,
